...
import 'package:neyasis_flutter_boilerplate/screens/home.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  _getApplicationConstants() async {
    ...
    Application.apiBaseUrl = environment["apiBaseUrl"][Application.appMode.path];
    Application.versionName = environment["versionName"][Application.appMode.path][platformKey];
    Application.versionCode = environment["versionCode"][Application.appMode.path][platformKey];
